...
export interface Level {
  ...
  /**
   * The length of inhaling in ms
   * @example 3000
   */
  inhale?: number;

  /**
   * The length of exhaling in ms
   * @example 3000
   */
  exhale?: number;
...
export interface User {
  ...
  /**
   * Which level the user is currently at
   * @example easy
   */
...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = "http://127.0.0.1:4010";
 ...
 *
 * API documentation for the breathing project...
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  exercises = {
     ...
     */
    exercisesList: (query?: { limit?: string }, params: RequestParams = {}) =>
     ...
     */
    exercisesCreate: (query?: { level?: string }, params: RequestParams = {}) =>
      this.request<{ message?: number }, { message?: string }>({
        path: `/exercises`,
        method: "POST",
        query: query,
        format: "json",
